const puzzle = {
    ...
    clues: {
        across: {
            4:  { clue: "Your clue for RUTH", row: 2, col: 0, length: 4 },
            5:  { clue: "Your clue for ORACLE", row: 2, col: 5, length: 6 },
            6:  { clue: "Your clue for BIGEYES", row: 4, col: 0, length: 7 },
            9:  { clue: "Your clue for FOODS", row: 6, col: 5, length: 5 },
            11: { clue: "Your clue for JAPAN", row: 7, col: 0, length: 5 },
            12: { clue: "Your clue for UNI", row: 8, col: 5, length: 3 },
        },
        down: {
            1:  { clue: "Your clue for WHOLE", row: 0, col: 5, length: 5 },
            2:  { clue: "Your clue for SHMEILA", row: 1, col: 3, length: 7 },
            3:  { clue: "Your clue for BEANS", row: 1, col: 10, length: 5 },
            7:  { clue: "Your clue for SPOON", row: 4, col: 6, length: 5 },
            8:  { clue: "Your clue for BAY", row: 6, col: 1, length: 3 },
            10: { clue: "Your clue for SWIM", row: 6, col: 9, length: 4 },
        }
    }
};
